...
export class ActivityEntry extends CardDef {
  ...
  @field activityDate = contains(StringField);
  @field studentName = contains(StringField);  // flat name (avoids cross-realm linksTo)
  @field authorName = contains(StringField);   // flat name
  @field sourceEntryId = contains(StringField); // URL of source AE in Classroom realm
